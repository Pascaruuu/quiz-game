...
<div class="game-wrapper">
  {#if game.currentQuestion && !game.isGameOver}
    ...
    <div class="timer-box">
      ...
      style="width: {(game.timeLeft / 30) * 68}%; background: {
        game.timeLeft > 15 ? '#4caf50' :
        game.timeLeft > 8  ? '#ff9800' :
                            '#f44336'
      }"
    ></div>
    </div>
    ...
    <div class="gameover">
      <div class="gameover-popup">
        ...
        <div class="gameover-btns">
          <a href="/" class="go-btn menu-btn">Main Menu</a>
          <a href="/leaderboard" class="go-btn menu-btn">Leaderboard</a>
